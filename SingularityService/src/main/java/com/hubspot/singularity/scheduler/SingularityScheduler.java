...
public class SingularityScheduler extends SingularitySchedulerBase {
  ...
  @Inject
  public SingularityScheduler(TaskManager taskManager, RequestManager requestManager, HistoryManager historyManager, SlaveManager slaveManager, RackManager rackManager, SingularityMailer mailer) {
    super(taskManager);
